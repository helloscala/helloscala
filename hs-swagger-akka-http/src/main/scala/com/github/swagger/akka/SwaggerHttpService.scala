...
object SwaggerHttpService {
  ...
  val readerConfig: DefaultReaderConfig = new DefaultReaderConfig

  val objectMapper: ObjectMapper = Jackson.defaultObjectMapper.registerModule(new DeserializationModule(true, true))

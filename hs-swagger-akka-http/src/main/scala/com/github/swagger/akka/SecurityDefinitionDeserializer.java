    ...
    public SecuritySchemeDefinition deserialize(JsonParser jp, DeserializationContext ctxt)
        ...
        if (inNode != null) {
            ...
            if ("basic".equals(type)) {
                result = io.swagger.util.Json.mapper().convertValue(node, BasicAuthDefinition.class);
            } else if ("apiKey".equals(type)) {
                result = io.swagger.util.Json.mapper().convertValue(node, ApiKeyAuthDefinition.class);

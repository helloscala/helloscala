...
@Path("/dict")
trait DictHttpService extends Directives {
  //  with ModelFormats {
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(name = "entry",
                           ...
                           dataType = "DictEntry",
                           paramType = "body")))
  @ApiResponses(Array(new ApiResponse(code = 400, message = "Client Error")))
  def createRoute = {
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(name = "key",
                           ...
                           dataType = "String",
                           paramType = "path")))
  @ApiResponses(Array(new ApiResponse(code = 404, message = "Dictionary does not exist.")))
  def readRoute = get {
